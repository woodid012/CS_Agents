...
// Nature of the entry — real deals/projects vs published reference data. Lets the
// UI separate "real projects" from "academic" reference data (CSIRO GenCost, NSW
// Benefit Sharing, archetypes), which all live under Benchmark.
export const DATA_CLASSES = ['Real', 'Benchmark'];
