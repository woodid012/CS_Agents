...
export const COMP_CATEGORIES = [
  ...
  },
  {
    ...
    metrics: [
      { key: 'it_load',         label: 'IT / critical load', defaultUnit: 'MW', defaultBasis: 'total' },
      { key: 'contracted_load', label: 'Contracted load',    defaultUnit: 'MW', defaultBasis: 'total' },
      { key: 'load_pipeline',   label: 'Load pipeline',      defaultUnit: 'MW', defaultBasis: 'total' },
    ],
  },
];
...
export const TECHNOLOGIES = [
  ...
  'Pumped hydro', 'Transmission', 'Hydrogen', 'Data centre', 'Platform', 'Other',
];
...
// Nature of the entry — real deals/projects vs published benchmarks vs
// illustrative placeholders. Lets the UI separate "real projects" from
// "academic" reference data (CSIRO GenCost, NSW Benefit Sharing, archetypes).
export const DATA_CLASSES = ['Real', 'Benchmark', 'Illustrative'];
