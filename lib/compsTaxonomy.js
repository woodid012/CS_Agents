...
export const UNITS = [
  ...
  '$/ha', '$/ha/yr',                       // land
  '%', 'x', 'years', 'hours', 'MW', 'MWh', 'MWac', 'MWdc', 'ha', 'ratio',
];
...
export const COMP_CATEGORIES = [
  ...
  },
  {
    ...
    metrics: [
      ...
      { key: 'ppa_tenor',     label: 'PPA tenor',           defaultUnit: 'years', defaultBasis: 'count' },
...
export const TECHNOLOGIES = [
  'Solar', 'Wind', 'Offshore Wind', 'BESS', 'Solar + BESS', 'Wind + BESS', 'Hybrid', 'Platform', 'Other',
];
export const STATES = ['NSW', 'VIC', 'QLD', 'SA', 'WA', 'TAS', 'NT', 'ACT', 'National'];
export const DEAL_TYPES = ['M&A', 'Asset acquisition', 'Platform', 'Development benchmark', 'EPC', 'Offtake', 'Refinancing', 'Capital raise'];
