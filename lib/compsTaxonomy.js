...
// Government schemes / tender rounds a deal can be tagged to (the comp_deals.program
// field). Free-text is allowed; these power the form's suggestion list + filters.
